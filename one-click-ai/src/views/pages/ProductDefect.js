...
export class ProductDefect extends Component {
    constructor() {
        super();
        this.title = "Product Defect Detection";
        ...
        return (
            <div className="card-wrapper">
                ...
                <div style={{ width: "100%" }} className="flex flex-col justify-center items-center">
                    ...
                    <Tag tags={this.tags} />
                    <Yt src="https://www.youtube.com/embed/tQ0yjYUFKAE" title="ProductDefect Video" />
                </div>
            </div>
        )
    }
