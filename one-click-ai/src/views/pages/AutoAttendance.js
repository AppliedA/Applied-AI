...
export class AutoAttendance extends Component {
    constructor() {
        super();
        this.title = "Automatic Attendence using Face Detection";
    ...
    render() {
        return (
            <div className="card-wrapper">
                <Helmet>
                    <title>Automatic Attendence using Face Detection</title>
                </Helmet>
                <div style={{ width: "100%" }} className="flex flex-col justify-center items-center">
                    ...
                    <Tag tags={this.tags} />
                    <Yt src="https://www.youtube.com/embed/tQ0yjYUFKAE" title="AutoAttendance Video" />
                </div>
            </div>
        )
    }
